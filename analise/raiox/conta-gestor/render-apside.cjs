...
(async () => {
  ...
  const htmlPath = path.resolve(__dirname, 'escopo-projeto-apside.html');
  ...
  await page.pdf({
    path: path.resolve(outputDir, 'escopo-projeto-apside.pdf'),
    landscape: true,
    format: 'A4',
    printBackground: true,
    margin: { top: '0', right: '0', bottom: '0', left: '0' }
  });
  console.log('Gerado escopo-projeto-apside.pdf');
