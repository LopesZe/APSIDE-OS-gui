...
| Scripts de venda / escada de preços | `vendas/` | script-progressao, roteiro-abordagem, escada-precos, script-venda-presencial |
...
| Skills disponíveis | `skills/` (índice em `SKILLS.md`) | procedimentos |
