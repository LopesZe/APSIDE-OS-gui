...
(async () => {
  ...
  // Also generate full page screenshot
  ...
  // Generate PDF
  await p.pdf({
    path: path.resolve(__dirname, 'instagram', 'apresentacao-gmb-carnes-cia.pdf'),
    landscape: true,
    format: 'A4',
    printBackground: true,
    margin: { top: '0', right: '0', bottom: '0', left: '0' }
  });
  console.log('Gerado apresentacao-gmb-carnes-cia.pdf');
